      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 w-full gap-4 lg:gap-0 items-center justify-center">
        ...
        >
          ...
          <div>
            ...
            <button
              className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-tertiary to-secondary hover:bg-slate-800 text-white mt-3">
        ...
        >
          <div
            className="rounded-full bg-[#181818] lg:w-[400px] lg:h-[400px] h-[150px] w-[150px]  relative">
            <Image
